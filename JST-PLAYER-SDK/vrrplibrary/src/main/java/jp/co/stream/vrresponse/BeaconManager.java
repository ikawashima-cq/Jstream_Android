...
class BeaconManager {
    ...
    private boolean mSendErrorBeaconFlg = false;
    public boolean getmSendErrorBeaconFlg() {
        return mSendErrorBeaconFlg;
    }
    public void setmSendErrorBeaconFlg(boolean b) {
        mSendErrorBeaconFlg = b;
    }
    ...
    public BeaconManager(boolean senderrorbeacon) {
        mSendErrorBeaconFlg  = senderrorbeacon;
    }
    ...
    public void sendErrorBeacon(Exception e)
    {
        try{
        if(mSendErrorBeaconFlg)
        {
                final String testbeaconurl = "http://e9efbdc0b7387d08b8183210c656d7a4.cdnext.stream.ne.jp/beacon/play.html";
            //final String testbeaconurl_co3 = "https://test01.co3.co.jp/CollectLog/beacontest.html";

            //String tmperr = e.getClass().getName() + ": " + e.getMessage();
            String tmperr = "";
            ...
            sendBeacon(testbeaconurl + "?err=" + tmperr, null, 60, 0);
            //sendBeacon(testbeaconurl_co3 + "?err=" + tmperr, null, 60, 0);
        }
