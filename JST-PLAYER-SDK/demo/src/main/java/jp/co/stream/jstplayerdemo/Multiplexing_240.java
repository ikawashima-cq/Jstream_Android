...
public class Multiplexing_240 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplexing_240);
        try {
    ...
    private void PlayOnVideoPlayer()
    {
        try{
            ...
            currentSamplePlayerModel = new SamplePlayerModel("SubAudio",inActivity.getString(R.string.url_multiplexing_240),false,false);
